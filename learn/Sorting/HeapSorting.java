 ...
 * 
 * 堆排序
 * 堆排序的核心思路是首先根据输入的数组序列构建一个 堆有序的二叉树，也就是说真个构建好的树
 * 符合堆的特点，但是不是有序的，只是根节点大于等于子节点
 * 
...
public class HeapSorting {
    ...
    public static void main(String[] args) {
        int[] a = { 1, 2, 3,23,45,63,437,345,457,3456,345,342,3456,3456,456,234,457,679,780, 5, 1, 2, 34, 5, 5, 1, 1 };
        sort(a);
        show(a);
    }
}