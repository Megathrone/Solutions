...
public class IntToEng {
    ...
    private String yibai(int phrase){
        ...
        String num2[] = {"ten","eleven","twelve","thirteen","fourteen","fifteen","sixtheen","seventeen","eighteen","nineteen"};
        String num3[] = {"","","twenty","thirty","fourty","fifty","sixthry","seventy","eighty","ninety"};
